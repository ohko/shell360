...
import { PortForwarding, PortForwardingType } from 'tauri-plugin-data';

export type PortForwardingFormFields = {
  name: string;
  portForwardingType: PortForwarding['portForwardingType'];
  hostId: string;
  localAddress: string;
  localPort: number | '';
...
export default function PortForwardingForm({
  formApi,
}: PortForwardingFormProps) {
